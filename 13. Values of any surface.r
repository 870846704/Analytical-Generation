...
## The function "plot.generalize" is used to generate surface of generalized Budyko equation in three dimensionless forms
...
## 2) "n1" is the first parameter in the generalized Budyko equations
## 3) "n2" is the second parameter in the generalized Budyko equations
## 4) "space" can be equal to "water", "energy", and "storage", which are scaled by P, PE, and Wp, respectively


## plot function
plot.generalize=function(equation="Yang-Yang",n1=1,n2=1,space="water"){
...
## example
## Fu -Fu equation with n1=2 and n2=1.2 in water-limited space
plot.generalize(equation="Fu-Fu",n1=2,n2=1.2,space="water")

## Fu -Fu equation with n1=2 and n2=1.2 in energy-limited space
plot.generalize(equation="Fu-Fu",n1=2,n2=1.2,space="energy")
